...
/**
 * Formats a date string as a human-readable relative time string in Spanish.
 * Extracted to module scope (REQ-FORMATDATE-1) so it is defined once and is
 * directly unit-testable without rendering the full component.
 */
